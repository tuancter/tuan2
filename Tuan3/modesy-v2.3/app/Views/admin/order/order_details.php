                        ...
                        <?php if ($order->buyer_id == 0): ?>
                            ...
                            <?php if (!empty($shipping)): ?>
                                <div class="row row-details">
                                    ...
                                    <div class="col-sm-8">
                                        <strong class="font-right">
                                            <?= $shipping->sFirstName ? esc($shipping->sFirstName) : ''; ?>&nbsp;
                                            <?= $shipping->sLastName ? esc($shipping->sLastName) : ''; ?>
                                ...
                                <div class="row row-details">
                                    ...
                                    <div class="col-sm-8">
                                        <strong class="font-right"><?= $shipping->sPhoneNumber ? esc($shipping->sPhoneNumber) : ''; ?></strong>
                                    </div>
                                </div>
                                <div class="row row-details">
                                    <div class="col-xs-12 col-sm-4 col-right">
                                    ...
                                    <div class="col-sm-8">
                                        <strong class="font-right"><?= $shipping->sEmail ? esc($shipping->sEmail) : ''; ?></strong>
                                    </div>
                                </div>
                            <?php endif;
                        else:
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bFirstName ? esc($shipping->bFirstName) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bLastName ? esc($shipping->bLastName) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bEmail ? esc($shipping->bEmail) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bPhoneNumber ? esc($shipping->bPhoneNumber) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bAddress ? esc($shipping->bAddress) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bCountry ? esc($shipping->bCountry) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bState ? esc($shipping->bState) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bCity ? esc($shipping->bCity) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->bZipCode ? esc($shipping->bZipCode) : ''; ?></strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sFirstName ? esc($shipping->sFirstName) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sLastName ? esc($shipping->sLastName) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sAddress ? esc($shipping->sAddress) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sCountry ? esc($shipping->sCountry) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sState ? esc($shipping->sState) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sCity ? esc($shipping->sCity) : ''; ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?= $shipping->sZipCode ? esc($shipping->sZipCode) : ''; ?></strong>
                                </div>
                            </div>
                        </div>
                    </div>
