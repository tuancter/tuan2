                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <?php if ($generalSettings->show_customer_email_seller == 1): ?>
                        <div class="line-detail line-detail-sm">
                            ...
                            <?= $shipping->sEmail ? esc($shipping->sEmail) : ''; ?>
                        </div>
                    <?php endif;
                    if ($generalSettings->show_customer_phone_seller == 1): ?>
                        <div class="line-detail line-detail-sm">
                            <span><?= trans("phone_number"); ?></span>
                            <?= $shipping->sPhoneNumber ? esc($shipping->sPhoneNumber) : ''; ?>
                        </div>
                    <?php endif; ?>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("address"); ?></span>
                        <?= $shipping->sAddress ? esc($shipping->sAddress) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("country"); ?></span>
                        <?= $shipping->sCountry ? esc($shipping->sCountry) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("state"); ?></span>
                        <?= $shipping->sState ? esc($shipping->sState) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("city"); ?></span>
                        <?= $shipping->sCity ? esc($shipping->sCity) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("zip_code"); ?></span>
                        <?= $shipping->sZipCode ? esc($shipping->sZipCode) : ''; ?>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("first_name"); ?></span>
                        <?= $shipping->bFirstName ? esc($shipping->bFirstName) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("last_name"); ?></span>
                        <?= $shipping->bLastName ? esc($shipping->bLastName) : ''; ?>
                    </div>
                    <?php if ($generalSettings->show_customer_email_seller == 1): ?>
                        <div class="line-detail line-detail-sm">
                            <span><?= trans("email"); ?></span>
                            <?= $shipping->bEmail ? esc($shipping->bEmail) : ''; ?>
                        </div>
                    <?php endif;
                    if ($generalSettings->show_customer_phone_seller == 1): ?>
                        <div class="line-detail line-detail-sm">
                            <span><?= trans("phone_number"); ?></span>
                            <?= $shipping->bPhoneNumber ? esc($shipping->bPhoneNumber) : ''; ?>
                        </div>
                    <?php endif; ?>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("address"); ?></span>
                        <?= $shipping->bAddress ? esc($shipping->bAddress) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("country"); ?></span>
                        <?= $shipping->bCountry ? esc($shipping->bCountry) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("state"); ?></span>
                        <?= $shipping->bState ? esc($shipping->bState) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("city"); ?></span>
                        <?= $shipping->bCity ? esc($shipping->bCity) : ''; ?>
                    </div>
                    <div class="line-detail line-detail-sm">
                        <span><?= trans("zip_code"); ?></span>
                        <?= $shipping->bZipCode ? esc($shipping->bZipCode) : ''; ?>
                    </div>
                </div>
            </div>
        <?php endif; ?>
