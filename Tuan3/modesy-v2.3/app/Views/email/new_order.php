                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="color: #555; padding-right: 10px;">
                                                        <?= trans("first_name"); ?>:&nbsp;<?= $shipping->sFirstName ? esc($shipping->sFirstName) : ''; ?><br>
                                                        <?= trans("last_name"); ?>:&nbsp;<?= $shipping->sLastName ? esc($shipping->sLastName) : ''; ?><br>
                                                        <?= trans("email"); ?>:&nbsp;<?= $shipping->sEmail ? esc($shipping->sEmail) : ''; ?><br>
                                                        <?= trans("phone_number"); ?>:&nbsp;<?= $shipping->sPhoneNumber ? esc($shipping->sPhoneNumber) : ''; ?><br>
                                                        <?= trans("address"); ?>:&nbsp;<?= $shipping->sAddress ? esc($shipping->sAddress) : ''; ?><br>
                                                        <?= trans("country"); ?>:&nbsp;<?= $shipping->sCountry ? esc($shipping->sCountry) : ''; ?><br>
                                                        <?= trans("state"); ?>:&nbsp;<?= $shipping->sState ? esc($shipping->sState) : ''; ?><br>
                                                        <?= trans("city"); ?>:&nbsp;<?= $shipping->sCity ? esc($shipping->sCity) : ''; ?><br>
                                                        <?= trans("zip_code"); ?>:&nbsp;<?= $shipping->sZipCode ? esc($shipping->sZipCode) : ''; ?><br>
                                                    </p>
                                                </td>
                                                <td>
                                                    <h3 style="margin-bottom: 10px; font-size: 16px;font-weight: 600;"><?= trans("billing_address"); ?></h3>
                                                    <p style="color: #555; padding-right: 10px;">
                                                        <?= trans("first_name"); ?>:&nbsp;<?= $shipping->bFirstName ? esc($shipping->bFirstName) : ''; ?><br>
                                                        <?= trans("last_name"); ?>:&nbsp;<?= $shipping->bLastName ? esc($shipping->bLastName) : ''; ?><br>
                                                        <?= trans("email"); ?>:&nbsp;<?= $shipping->bEmail ? esc($shipping->bEmail) : ''; ?><br>
                                                        <?= trans("phone_number"); ?>:&nbsp;<?= $shipping->bPhoneNumber ? esc($shipping->bPhoneNumber) : ''; ?><br>
                                                        <?= trans("address"); ?>:&nbsp;<?= $shipping->bAddress ? esc($shipping->bAddress) : ''; ?><br>
                                                        <?= trans("country"); ?>:&nbsp;<?= $shipping->bCountry ? esc($shipping->bCountry) : ''; ?><br>
                                                        <?= trans("state"); ?>:&nbsp;<?= $shipping->bState ? esc($shipping->bState) : ''; ?><br>
                                                        <?= trans("city"); ?>:&nbsp;<?= $shipping->bCity ? esc($shipping->bCity) : ''; ?><br>
                                                        <?= trans("zip_code"); ?>:&nbsp;<?= $shipping->bZipCode ? esc($shipping->bZipCode) : ''; ?><br>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
